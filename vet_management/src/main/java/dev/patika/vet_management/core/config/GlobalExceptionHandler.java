...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AlreadyRegisterException.class)
        public ResponseEntity<Result> handleAlreadyRegisteredException(AlreadyRegisterException e) {
        return new ResponseEntity<>(ResultHelper.alreadyRegistered(e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
